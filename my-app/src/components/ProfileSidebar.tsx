...
const ProfileSidebar = () => {
  ...
  // Update userIsSeller whenever location changes
  useEffect(() => {
      ...
      <nav className="flex-1 px-2 py-2 space-y-1">
        <button 
          ...
          className={`w-full flex items-center gap-3 px-3 py-2 text-sm rounded-md ${
            isActive('/profile') || isActive('/seller-profile')
        ...
        >
          <MessageSquare className="h-4 w-4" /> Messages <Badge variant="secondary" className="ml-auto">0</Badge>
        </button>
        <button 
        ...
        >
          <Bell className="h-4 w-4" /> Notifications <Badge variant="secondary" className="ml-auto">0</Badge>
        </button>
        ...
        {userIsSeller && (
          <div className="pt-4">
            ...
            >
              <TrendingUp className="h-4 w-4" /> Seller Insights
            </button>
          </div>
        )}
