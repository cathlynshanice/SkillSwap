...
const OffersSection = () => {
  ...
  return (
    <section
      id="offers"
      className="min-h-screen flex items-center py-20 lg:py-24 bg-background"
    >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-4 lg:mb-6">
          {students.map((student, idx) => (
            ...
            >
              ...
              <Badge
                className={`${student.badgeColor} text-foreground mb-2 lg:mb-3 text-xs`}
              >
                {student.badge}
              </Badge>

              <div className="flex items-center gap-2 lg:gap-3 mb-2 lg:mb-3">
                <Instagram className="w-3 h-3 lg:w-3.5 h-3.5 cursor-pointer hover:text-primary transition-colors" />
                <Facebook className="w-3 h-3 lg:w-3.5 h-3.5 cursor-pointer hover:text-primary transition-colors" />
                <Linkedin className="w-3 h-3 lg:w-3.5 h-3.5 cursor-pointer hover:text-primary transition-colors" />
              </div>
            ...
            <div>
              ...
              <div className="flex gap-2 lg:gap-3">
                <Button
                  variant="secondary"
                  size="lg"
                  className="gap-1.5 lg:gap-2 text-xs lg:text-sm px-3 lg:px-4 bg-white text-blue-600 hover:bg-white/90"
                >
                  Find a Skill{" "}
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="gap-1.5 lg:gap-2 bg-white text-blue-600 hover:bg-white/90 border-white text-xs lg:text-sm px-3 lg:px-4"
                >
                  Offer a Skill{" "}
                  <ArrowRight className="w-3.5 h-3.5 lg:w-4 lg:h-4" />
                </Button>
